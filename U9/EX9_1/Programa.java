...
public class Programa {
    ...
    static Vector<Alumne> Alumnat = new Vector <Alumne>(50);
    static Vector<Profesor> Professorat  = new Vector <Profesor>(50);
    ...
    public static void CrearAlumne() {
        ...
        Alumnat.add(new Alumne(Nom, DNI, Edad, Nivel));
        Alumnes++;
    }
    ...
    public static void CrearProfessor() {
        ...
        Professorat.add(new Profesor(Nom, DNI, Edad, asignatura));
        Profesors++;
    }
